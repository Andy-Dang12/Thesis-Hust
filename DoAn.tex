...
\chapter{BÀI TOÁN NGHIÊN CỨU, PHÁT HIỆN VÀ CÁC BÀI BÁO VỀ UNG THƯ VÀ XÁC ĐỊNH CÁC ĐỘT BIẾN GENE TƯƠNG ỨNG}
\subfile{Chuong/1_Gioi_thieu} % Phần mở đầu

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{CƠ SỞ LÝ THUYẾT CỦA BÀI TOÀN PHÂN LOẠI VĂN BẢN}
\subfile{Chuong/2_Co_so_ly_thuyet}


\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{ĐỀ XUẤT PHƯƠNG SỬ DỤNG THUẬT TOÁN HỌC MÁY VÀ BIỂU THỨC CHÍNH QUY}
...
% \chapter{Danh sách biểu thức chính quy}
